...
public class PagerSlidingTabStripForNoPreload extends HorizontalScrollView {
     ...
     * 底部滑动的ViewPager
     */
    protected NoPreloadViewPager mPager;
     ...
     */
    private NoPreloadViewPager.OnPageChangeListener mDelegatePageListener;
    /**
     * 文字Tab添加监听事件
     */
    ...
    public PagerSlidingTabStripForNoPreload(Context context) {
        this(context, null);
    }

    public PagerSlidingTabStripForNoPreload(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabStripForNoPreload(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs, defStyle, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PagerSlidingTabStripForNoPreload(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public NoPreloadViewPager getViewPager() {
        return mPager;
    }
    ...
    protected class PageListener implements NoPreloadViewPager.OnPageChangeListener {
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == NoPreloadViewPager.SCROLL_STATE_IDLE) {
