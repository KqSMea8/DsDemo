...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OkBus.getInstance().register(Constants.MODULE_B_EVENT001,
                mEvent = msg -> LogUtils.logOnUI(Constants.TAG, "service进程收到消息:Message-->service: " + msg.obj));
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.bt_a) {
            //子组件打开url时需要告知模块id，用于自动唤醒，主app则不需要
            Router.open(this, "moduleHost://com.module.moduleA?module=a");
        } else if (i == R.id.bt_b) {
